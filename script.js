...
const translations = {
    es: {
        ...
        'projects.taitou.title': 'Taitou Finances - PWA de Finanzas',
        'projects.martinca.title': 'Martinca - Estructuras Metálicas',
        'projects.gestoria.title': 'Gestoría & Asesoría Integral',
        'projects.vitalsport.title': 'Vitalsport - Clínica & Salud',
        'projects.peiro.title': 'Peiro - Entrenamiento Personal',
        'projects.calasanz.title': 'Calassanz 15 - Menjars per Emportar',
        'projects.taitou.desc': 'PWA full-stack estilo glassmorphism. Desarrollada con Vanilla JS en frontend, y Node.js + Express + SQLite en backend.',
        'projects.martinca.desc': 'Web corporativa para empresa de construcciones metálicas. Diseño industrial moderno centrado en la exhibición de grandes estructuras.',
        'projects.gestoria.desc': 'Solución web profesional para despacho de asesores. Presentación clara de servicios fiscales y laborales para empresas y autónomos.',
        'projects.vitalsport.desc': 'Sitio web para centro de fisioterapia avanzada y salud deportiva. Diseño limpio que transmite confianza y bienestar.',
        'projects.peiro.desc': 'Landing page dinámica para entrenador personal. Enfocada en la captación de clientes y muestra de planes de entrenamiento.',
        'projects.calasanz.desc': 'Web corporativa para negocio de comida casera tradicional. Muestra de menú semanal y opciones gastronómicas locales.',
    ...
    en: {
        ...
        'projects.taitou.title': 'Taitou Finances - Finance PWA',
        'projects.martinca.title': 'Martinca - Metal Structures',
        'projects.gestoria.title': 'Gestoría & Integral Advisory',
        'projects.vitalsport.title': 'Vitalsport - Clinic & Health',
        'projects.peiro.title': 'Peiro - Personal Training',
        'projects.calasanz.title': 'Calassanz 15 - Takeaway Food',
        'projects.taitou.desc': 'Full-stack glassmorphism PWA. Built with Vanilla JS on the frontend, and Node.js + Express + SQLite on the backend.',
        'projects.martinca.desc': 'Corporate website for metal construction company. Modern industrial design focused on showcasing large structures.',
        'projects.gestoria.desc': 'Professional web solution for advisory firm. Clear presentation of tax and labor services for companies and freelancers.',
        'projects.vitalsport.desc': 'Website for advanced physiotherapy and sports health center. Clean design conveying confidence and wellness.',
        'projects.peiro.desc': 'Dynamic landing page for personal trainer. Focused on client acquisition and showcasing training plans.',
        'projects.calasanz.desc': 'Corporate website for traditional homemade food business. Weekly menu display and local gastronomic options.',
